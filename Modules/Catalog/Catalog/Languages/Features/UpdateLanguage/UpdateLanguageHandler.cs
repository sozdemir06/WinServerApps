...
namespace Catalog.Languages.Features.UpdateLanguage;
...
public class UpdateLanguageHandler(CatalogDbContext dbContext) : ICommandHandler<UpdateLanguageCommand, UpdateLanguageResult>
{
