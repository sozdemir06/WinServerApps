...
using Catalog.AppTenants.Exceptions;
using Catalog.AppTenants.Models;
using Catalog.Data;

namespace Catalog.AppTenants.Features.CreateAppTenant;
...
public class CreateAppTenantHandler(CatalogDbContext dbContext, ILocalizationService localizationService) : ICommandHandler<CreateAppTenantCommand, CreateAppTenantResult>
{
