...
namespace Catalog.AppTenants.Features.UpdateAppTenant;
...
public class UpdateAppTenantHandler(CatalogDbContext dbContext) : ICommandHandler<UpdateAppTenantCommand, UpdateAppTenantResult>
{
