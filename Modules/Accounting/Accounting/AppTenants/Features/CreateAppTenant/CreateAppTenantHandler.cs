...
using Accounting.AppTenants.Exceptions;


namespace Accounting.AppTenants.Features.CreateAppTenant;
...
public class CreateAppTenantHandler(AccountingDbContext dbContext, ILocalizationService localizationService) : ICommandHandler<CreateAppTenantCommand, CreateAppTenantResult>
{
