...
namespace Accounting.AppTenants.Features.UpdateAppTenant;
...
public class UpdateAppTenantHandler(AccountingDbContext dbContext) : ICommandHandler<UpdateAppTenantCommand, UpdateAppTenantResult>
{
