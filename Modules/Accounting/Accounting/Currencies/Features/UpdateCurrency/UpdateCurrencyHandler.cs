...
namespace Accounting.Currencies.Features.UpdateCurrency;
...
public class UpdateCurrencyHandler(AccountingDbContext dbContext) : ICommandHandler<UpdateCurrencyCommand, UpdateCurrencyResult>
{
